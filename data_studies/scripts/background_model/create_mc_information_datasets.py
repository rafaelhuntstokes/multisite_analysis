...
nhits_scaled_files  = glob.glob(path + "/scaled_nhits/*.npy")
nhits_cleaned_files = glob.glob(path + "/cleaned_nhits/*.npy")
...
combined_nhits_scaled  = adder(nhits_scaled_files)
combined_nhits_cleaned = adder(nhits_cleaned_files)
...
np.save(path + "/nhits_scaled.npy", combined_nhits_scaled)
np.save(path + "/nhits_cleaned.npy", combined_nhits_cleaned)
