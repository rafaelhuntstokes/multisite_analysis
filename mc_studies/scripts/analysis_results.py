...
def plot_itr_as_discriminant():
    ...
    axes[2].set_xlabel("Signal Acceptance", fontsize = 20)
    axes[2].set_ylabel("Background Acceptance", fontsize = 20)
    axes[0].set_title("Comparison of ITR and Multisite Discriminants", fontsize = 20)
